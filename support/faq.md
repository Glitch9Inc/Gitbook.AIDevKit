...
* **Run models locally with Ollama**\
  ...
  [Start settings up Ollama here.](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/quick-start/self-hosting-with-ollama.md)
...
* **Try OpenRouter’s free models**\
  **OpenRouter** aggregates access to various models — some of which are free to use without authentication. You can easily distinguish which models are free using [AI Dev Kit Model Library.](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/1_introduction/broken-reference/README.md)\
  [Get OpenRouter's free API key here.](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/quick-start/api-key-setup/openrouter.md)
