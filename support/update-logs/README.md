...
For version 2.x release notes, see [AI Dev Kit v2](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/1_main/update-logs/ai-dev-kit-v2.md).

For version 1.x release notes, see [AI Dev Kit v1](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/1_main/update-logs/ai-dev-kit-v1.md).
