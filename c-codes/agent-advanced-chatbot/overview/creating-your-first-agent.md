...
{% hint style="info" %}
Make sure you have already [set up your API key](../../../introduction/getting-started/api-key-setup/) before continuing.
{% endhint %}
...
| **Conversation Starter** | _(Optional)_ First message the agent sends when a conversation begins |
| **Traits**               | _(Optional)_ Personality toggles: Witty, Encouraging, Direct, etc.    |
...
## Step 5 - Handle Streaming Responses _(optional)_
...
| Mode                          | When to use                                                                                                                     |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| **AutoInit = On** _(default)_ | Agent initializes when the scene starts. Safe for most projects.                                                                |
