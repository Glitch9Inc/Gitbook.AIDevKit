...
1. "user is asking about billing or payments" → billing\_instructions
2. "user is reporting a bug or technical issue" → tech\_support\_instructions
3. "user wants to request a new feature" → feature\_request\_instructions
...
* [Adaptive Instructions Overview](./) - Main guide
...
* [Tool Routing](../tool-integrations/tool-routing.md) - Similar embedding-based system for tools
