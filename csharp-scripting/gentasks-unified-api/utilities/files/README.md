...
* [Upload File](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/3_requests/utilities/files/upload-file.md) - Upload generic files
* [Upload Image](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/3_requests/utilities/files/upload-image.md) - Upload images
* [Upload Audio](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/3_requests/utilities/files/upload-audio.md) - Upload audio
* [Upload Screenshot](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/3_requests/utilities/files/upload-screenshot.md) - Capture and upload
* [Download File](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/3_requests/utilities/files/download-file.md) - Download files
* [Delete File](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/3_requests/utilities/files/delete-file.md) - Remove files
* [List Files](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/3_requests/utilities/files/list-files.md) - Browse files
