...
* [Request vs Execute](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/3_requests/overview/request-vs-execute.md) - Understanding when API calls happen
