...
4. **Auto-initialize** _(if enabled)_ - immediately calls `Agent.InitializeAsync()`
...
### Step 5 - Tool Call Loop _(only when the model requests tools)_
...
See [Agent Events](events.md) for the full list and usage examples.
