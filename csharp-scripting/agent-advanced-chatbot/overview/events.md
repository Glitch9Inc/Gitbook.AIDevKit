...
* [Overview](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/4_agent/events/overview.md) - Detailed event system architecture
* [Registering Events](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/4_agent/events/registering-events.md) - Registration and lifecycle management
* [Available Events](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/4_agent/events/available-events.md) - Complete event reference
