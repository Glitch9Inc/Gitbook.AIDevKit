...
* Learn about [Tool Compatibility](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/tools/what-are-tools.md) with different API types
* Explore [Creating Your First Agent](creating-your-first-agent.md)
* Understand [Agent Events](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/events/overview.md)
* Read about [Conversation Management](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/conversations/how-conversations-work.md)
