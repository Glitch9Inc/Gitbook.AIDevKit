...
| [Memory (RAG)](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/4_agent/overview/memory.md) | Conversation history, context windows, and long-term retrieval |

Learn the fundamentals of working with agents:

* [How Agents Work](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/4_agent/overview/how-agents-work.md) - Core concepts and architecture
* [Your First Agent](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/4_agent/overview/your-first-agent.md) - Quick start guide
* [Agent vs Request](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/4_agent/overview/agent-vs-request.md) - When to use agents vs direct requests

## Core Components

Dive into the agent system's building blocks:

* [Agent Services](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/4_agent/overview/agent-services.md) - Service architecture and dependencies
* [Controllers](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/4_agent/overview/controllers.md) - Conversation, audio, and image controllers
* [Event Router](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/4_agent/overview/event-router.md) - Advanced event routing and filtering

## Customization

Extend agents with custom implementations:

* [Custom Chat Services](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/4_agent/overview/custom-chat-services.md) - Integrate custom LLM providers
...
1. Create your first agent with [Your First Agent](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/4_agent/overview/your-first-agent.md)
2. Understand the architecture in [How Agents Work](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/4_agent/overview/how-agents-work.md)
3. Learn about [Agent Services](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/4_agent/overview/agent-services.md)
4. Explore [Event Router](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/AIDevKit/Unity.AIDevKit/4_agent/overview/event-router.md) for advanced patterns
