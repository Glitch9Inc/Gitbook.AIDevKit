...
\| Field | Description | |---|---|---| | **Persona** | Assigns an [Agent Persona](agent-persona.md) asset that defines personality and instructions | | **Model** | AI model to use (gpt-4o, claude-3-5-sonnet, etc.) |
...
_Enabled when **Reasoning** capability is checked._
...
_Enabled when **Tools** capability is checked._
...
_Enabled when **Audio Input** or **Audio Output** capabilities are checked._
...
_Enabled when **Adaptive Instructions** capability is checked._
...
* Review tool registration in [Tool Managers](https://github.com/Glitch9Inc/Gitbook.AIDevKit/blob/main/4_agent/components/tool-managers.md)
